  ...
  renderPage(speechPart) {
    content.innerHTML = `
      <div class="training-list">
          <div class="training-card training-card--write" id="writeTraining">
          ...
          <div class="training-card training-card--puzzle" id="puzzleTraining">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div class="training-card training-card--choose" id="chooseTraining">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 16 16">

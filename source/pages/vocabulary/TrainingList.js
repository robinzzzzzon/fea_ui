  ...
  renderPage(speechPart) {
    content.innerHTML = `
      <div class="training-list">
          <div class="training-card" id="writeTraining">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-keyboard-fill" viewBox="0 0 16 16">
              ...
              <span class="training-card__label">Write</span>
          </div>
          <div class="training-card" id="puzzleTraining">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-puzzle-fill" viewBox="0 0 16 16">
              ...
              <span class="training-card__label">Puzzle</span>
          </div>
          <div class="training-card" id="chooseTraining">
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-grid-fill" viewBox="0 0 16 16">
